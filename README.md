...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymc3-ext-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10881&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymc3-ext-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymc3-ext` can be installed with:

```
conda install pymc3-ext
```

It is possible to list all of the versions of `pymc3-ext` available on your platform with:
